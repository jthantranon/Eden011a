...
MEUI.DialogChat = function (props) {
	...
	this.init = function() {
		...
		this.$domctx.jqoteapp('#dialogChatTmpl');
...
MEUI.extend(MEUI.Sheet, MEUI.DialogChat);

// prototype inheritance
MEUI.DialogChat.prototype.constructor = MEUI.DialogChat;
